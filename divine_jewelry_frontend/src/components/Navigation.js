...
function Navigation() {
  ...
  return (
    <Navbar bg="light" expand="lg">
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand>Divine Jewelry</Navbar.Brand>
        </LinkContainer>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            {user && (
              <LinkContainer to="/category/necklaces">
                <Nav.Link>Necklaces</Nav.Link>
              </LinkContainer>
            )}
            {user && (
              <LinkContainer to="/category/bracelets">
                <Nav.Link>Bracelets</Nav.Link>
              </LinkContainer>
            )}
            {user && (
              <LinkContainer to="/category/fine%20watches">
                <Nav.Link>Fine Watches</Nav.Link>
              </LinkContainer>
            )}
